...
逐个知识库处理：先增量检查，有真实下载时才显示下载状态行（已下载量 · 速度 · 更新篇数），无更新时只显示一行结果：
...
共 9 个知识库，本次同步 9 个：
   ...
   √ [1/9] 个人信息: 无更新
   ↓ [2/9] 数字生活 已下载 12.5 MB · 2.1 MB/s · 3 篇更新     ← 仅在实际下载数据时出现
   √ [2/9] 数字生活: 下载 12.5 MB，3 篇更新
   - [3/9] 技术: 检测到 1 篇本地文件缺失（可能被杀毒软件隔离），将重新下载
   ...

√ 同步完成：9 个知识库，共处理 414 篇笔记，本次下载 12.5 MB
```
